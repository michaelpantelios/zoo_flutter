...
final appThemeData = {
  AppTheme.Theme1: ThemeData(
    ...
    textTheme: TextTheme(
        ...
        headline6: TextStyle(fontSize: 17.0, color: Colors.white, fontWeight: FontWeight.bold),
        button: TextStyle(fontSize: 14.0, color: Colors.white, fontWeight: FontWeight.normal),
        bodyText1: TextStyle(fontSize: 12.0, color: Color(0xFF7a7a7a), fontWeight: FontWeight.normal),
        bodyText2: TextStyle(fontSize: 12.0, color: Color(0xFFFFFFFF), fontWeight: FontWeight.normal)),
    buttonColor: Color(0xFF428f83),
