...
class ZMQConnection {
  ...
  Future<void> connect(String sessionKey) async {
    ...
    if (_con == null) throw "cannot connect";
    ...
    if (_authRes != null) authenticate(_sessionKey);
  }
  ...
  Future<bool> authenticate(String sessionKey) {
    ...
    if (_authRes == null) _authRes = new Completer<bool>();
  ...
  String _nextUrl() {
    if (_hosts.length == 0) _hosts = List.from(Env.zmqHosts);
