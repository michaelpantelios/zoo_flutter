...
class PointsManiacsItemState extends State<PointsManiacsItem> {
  ...
  update(PointsManiacRecord data) {
    setState(() {
      _hasMainPhoto = false;
      _data = data;
      if (data.user.mainPhoto != null) if (data.user.mainPhoto["image_id"] != null) _hasMainPhoto = true;
    });
  }
  ...
  Widget build(BuildContext context) {
    return _data == null
        ? SizedBox(width: PointsManiacsItem.myWidth, height: PointsManiacsItem.myHeight)
        : GestureDetector(
            onTap: () {
                        ...
                        child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ClipOval(
                                  child: _hasMainPhoto
                                      ? Image.network(Utils.instance.getUserPhotoUrl(photoId: _data.user.mainPhoto["image_id"].toString()), height: 45, width: 45, fit: BoxFit.cover)
                                      : Image.asset(_data.user.sex == 1 ? "assets/images/home/maniac_male.png" : "assets/images/home/maniac_female.png", height: 45, width: 45, fit: BoxFit.cover),
                                ),
