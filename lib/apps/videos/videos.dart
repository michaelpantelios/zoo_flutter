...
class VideosState extends State<Videos> {
  ...
  Widget build(BuildContext context) {
    String pagingText = AppLocalizations.of(context).translate("app_videos_lblPage") + " " + currentVideosPage.toString() + " " + AppLocalizations.of(context).translate("app_videos_lblFrom") + " " + totalPages.toString();
