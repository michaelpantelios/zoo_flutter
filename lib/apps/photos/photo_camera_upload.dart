...
class PhotoCameraUploadState extends State<PhotoCameraUpload> {
  ...
  void initState() {
    ...
    photoCaptureButtonKey = new GlobalKey<ZButtonState>();
    photoCaptureAgainButtonKey = new GlobalKey<ZButtonState>();
    savePhotoButtonKey = new GlobalKey<ZButtonState>();
          ...
          children: [
            ...
            Expanded(
                child: Container(
                    ...
                    child: Row(
                      children: [
                        Expanded(child: CameraPhotoThumb(key: photoThumb1Key, id: "thumb1", onClickHandler: onCameraThumbTapHandler)),
                        SizedBox(width: 5),
                        Expanded(child: CameraPhotoThumb(key: photoThumb2Key, id: "thumb2", onClickHandler: onCameraThumbTapHandler)),
                        SizedBox(width: 5),
                        Expanded(child: CameraPhotoThumb(key: photoThumb3Key, id: "thumb3", onClickHandler: onCameraThumbTapHandler)),
                      ],
                    )))
          ],
        ));
