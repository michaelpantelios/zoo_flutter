            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Container(width: 140, height: 50, child: ZButton(key: uploadButtonKey, clickHandler: onUploadHandler, buttonColor: Colors.white, icon: Icons.upload_rounded, iconSize: 25, iconColor: Colors.green, label: AppLocalizations.of(context).translate("app_photos_file_upload_btnUpload")))
                ],
              ),
            )
          ],
