...
import 'package:zoo_flutter/apps/chat/messages_list.dart';
...
class ChatState extends State<Chat> {
  ...
  final _key = new GlobalKey<MessagesListState>();
                      ...
                      Container(
                          ...
                          child:  RaisedButton(
                            ...
                            onPressed: (){
                              ...
                              _key.currentState.addPublicMessage(User.instance.userInfo, sendMessageController.text);
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Padding(
                                    padding: EdgeInsets.all(3),
                                    child: Text(AppLocalizations.of(context).translate("app_chat_btn_send"),
