       ...
       children: [
        ...
        SizedBox(height: 20),
         Padding(
             ...
             child: Html(
                 data: AppLocalizations.of(context).translateWithArgs("app_star_tl_txtStep1", [DataMocker.premiumStarPhoneSettings["phoneStarGateway"]]),
                 style: {
                   "html": Style(
                       backgroundColor: Colors.white,
                       color: Colors.black,
         ...
         Padding(
             padding: EdgeInsets.only(left: 60, bottom: 5, right:5, top: 5),
             child: Html(
                 data: AppLocalizations.of(context).translateWithArgs("app_star_tl_txtStep2", [User.instance.userInfo.userId.toString()]),
                 style: {
                   "html": Style(
                       backgroundColor: Colors.white,
                       color: Colors.black,
         ...
         Padding(
             padding: EdgeInsets.only(left: 60, bottom: 5, right:5, top: 5),
             child: Html(
                 data: AppLocalizations.of(context).translateWithArgs("app_star_tl_txtCredits", [DataMocker.premiumStarPhoneSettings["phoneStarCellCost"], DataMocker.premiumStarPhoneSettings["phoneStarFixedCost"], DataMocker.premiumStarPhoneSettings["phoneStarProvider"]  ]),
                 style: {
                   "html": Style(
                       backgroundColor: Colors.white,
                       color: Colors.black,
