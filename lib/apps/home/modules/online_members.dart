                              ...
                              children: [
                                Flexible(
                                  child: Padding(
                                      ...
                                      child: Text(info.username, style: TextStyle(color: Color(0xffFF9C00), fontSize: 15), textAlign: TextAlign.left,
                                        overflow: TextOverflow.ellipsis,
                                        maxLines: 1,)
                                  ),
                                ),
      ...
      setState(() {
        ...
        for(int i=0; i<records.length; i++){
          ...
          if (int.parse(_rec.me["sex"].toString()) == 1 && _malesFound < 4){
            _malesFound++;
            _maleMembers.add(getMemberItem(_rec));
          } else if (int.parse(_rec.me["sex"].toString()) == 2 && _femalesFound < 4){
            _femalesFound++;
            _femaleMembers.add(getMemberItem(_rec));
          }
        }
      });
    } else {
