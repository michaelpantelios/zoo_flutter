            ...
            Padding(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    SizedBox(height: 10),
                    getListTileOption(Image.asset("assets/images/common/sms_icon.png", height: 40), "app_coins_pm_pm1", PurchaseOption.sms),
                    SizedBox(height: 10),
                    getListTileOption(Image.asset("assets/images/common/phone_icon.png", height: 40), "app_coins_pm_pm2", PurchaseOption.phone),
                    SizedBox(height: 10),
                    getListTileOption(Image.asset("assets/images/common/paypal_icon.png", height: 40), "app_coins_pm_pm3", PurchaseOption.paypal),
                    SizedBox(height: 10),
                    getListTileOption(Image.asset("assets/images/common/cc_icon.png", height: 40), "app_coins_pm_pm4", PurchaseOption.card),
                    SizedBox(height: 10),
                    getListTileOption(Image.asset("assets/images/common/paysafe_icon.png", height: 40), "app_coins_pm_pm5", PurchaseOption.paysafe),
                  ],
                ),
              ),
            ),
