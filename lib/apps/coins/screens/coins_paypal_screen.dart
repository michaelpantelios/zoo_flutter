        ...
        child: Column(
          ...
          children: [
            Stack(
              children: [
                Image.asset(
                  "assets/images/coins/paypal_header.png",
                ),
                Positioned(
                  top: 20,
                  left: 220,
                  child: Container(
                      width: 300,
                      // height: 100,
                      child: Html(data: AppLocalizations.of(context).translate("app_coins_pp_txtHeader"), style: {
            ...
            Padding(
              ...
              child: Html(
                data: AppLocalizations.of(context).translate(UserProvider.instance.userInfo.isStar ? "app_coins_pp_subHeaderStar" : "app_coins_pp_subHeaderNonStar"),
                style: {
                  "html": Style(backgroundColor: Colors.white, color: Colors.black, fontSize: FontSize.medium, textAlign: TextAlign.left, fontWeight: FontWeight.w500),
                },
              ),
            ),
            Container(
