...
class CoinsSmsScreenState extends State<CoinsSmsScreen>{
  ...
  bool noStarNoCoins = User.instance.userInfo.coins == 0 && User.instance.userInfo.star;
  ...
  Widget build(BuildContext context) {
    ...
    Widget offerOkArea() {
      return Column(
        ...
        children: [
          Html(
              data: AppLocalizations.of(context).translate("app_coins_sm_hasBundle"),
              style: {
                "html": Style(
          ...
          Padding(
            ...
            child: Text(AppLocalizations.of(context).translateWithArgs("app_coins_sm_prompt", [smsCoinsKeyword, offerCode, smsCoinsGateway ]),
            style: TextStyle(color: Colors.red, fontSize: 30, fontWeight: FontWeight.bold),
            textAlign: TextAlign.center)
          ),
          Html(
              data: AppLocalizations.of(context).translate("app_coins_sm_txtStarInfo"),
              style: {
                "html": Style(
                    backgroundColor: Colors.white,
                    color: Colors.black,
      ...
      return Column(
        mainAxisAlignment: MainAxisAlignment.center,
          children: [
            ...
            Html(
                data: AppLocalizations.of(context).translate("app_coins_sm_txtNoCoinsNoStarInfo"),
                style: {
                  "html": Style(
                      backgroundColor: Colors.white,
                      color: Colors.black,
            ...
            Padding(
                ...
                child: Text(AppLocalizations.of(context).translateWithArgs("app_coins_sm_prompt", [smsCoinsKeyword, comboCode, smsCoinsGateway ]),
                    style: TextStyle(color: Colors.red, fontSize: 30, fontWeight: FontWeight.bold),
                    textAlign: TextAlign.center)
            ),
            Padding(
              ...
              child: Text(
                AppLocalizations.of(context).translate("app_coins_sm_txtOR"),
                style: Theme.of(context).textTheme.headline3,
                textAlign: TextAlign.center
              )
            ),
            ...
            Html(
                data: AppLocalizations.of(context).translate("app_coins_sm_txtNoStarNoCoinsOnlyInfo"),
                style: {
                  "html": Style(
                      backgroundColor: Colors.white,
                      color: Colors.black,
            ...
            Padding(
                padding: EdgeInsets.only(top: 20,bottom: 5),
                child: Text(AppLocalizations.of(context).translateWithArgs("app_coins_sm_prompt", [smsCoinsKeyword, coinsCode, smsCoinsGateway ]),
                    style: TextStyle(color: Colors.red, fontSize: 30, fontWeight: FontWeight.bold),
                    textAlign: TextAlign.center)
            ),
    ...
    Widget simpleArea() {
      ...
      return Column(
        children: [
          Html(
              data: AppLocalizations.of(context).translate(User.instance.userInfo.star ? "app_coins_sm_txtSimpleInfoStar" : "app_coins_sm_txtSimpleInfoSimple"),
              style: {
                "html": Style(
                    backgroundColor: Colors.white,
                    color: Colors.black,
          ...
          Padding(
            padding: EdgeInsets.symmetric(vertical: 10),
            child:Html(
                data: AppLocalizations.of(context).translate(User.instance.userInfo.star ? "app_coins_sm_txtSimpleStarYes" : "app_coins_sm_txtSimpleStarNo"),
                style: {
                  "html": Style(
                      backgroundColor: Colors.white,
                      color: Colors.black,
          ...
          Padding(
              padding: EdgeInsets.only(top: 20,bottom: 5),
              child: Text(AppLocalizations.of(context).translateWithArgs("app_coins_sm_prompt", [smsCoinsKeyword, coinsCodeSimple, smsCoinsGateway ]),
                  style: TextStyle(color: Colors.red, fontSize: 30, fontWeight: FontWeight.bold),
                  textAlign: TextAlign.center)
          )
        ...
        child: Column(
          children: [
            Row(
              children: [
                ...
                Container(
                  ...
                  child: Html(
                      data: AppLocalizations.of(context).translate("app_coins_sm_txtHeader"),
                      style: {
                        "html": Style(
                            backgroundColor: Colors.white,
                            color: Colors.black,
            ...
            Container(
              ...
              child: !dataReady ? Container() : offerServiceResOk ? offerOkArea() : noStarNoCoins ? noStarNoCoinsArea() : simpleArea()
            ),
            Expanded(child: Container()),
            Padding(
              padding: EdgeInsets.symmetric(vertical: 5),
              child: Text(AppLocalizations.of(context).translateWithArgs("app_coins_sm_txtCredits", [smsCoinsCost, smsCoinsProvider]),
