        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                ...
                Container(
                    ...
                    child: HTML.toRichText(context, AppLocalizations.of(context).translate("app_coins_cc_txtHeader"), overrideStyle: {
            ...
            Padding(
                ...
                child: HTML.toRichText(context, AppLocalizations.of(context).translate(UserProvider.instance.userInfo.isStar ? "app_coins_cc_subHeaderStar" : "app_coins_cc_subHeaderNonStar"), overrideStyle: {
