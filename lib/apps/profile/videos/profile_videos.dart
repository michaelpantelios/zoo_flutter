...
class ProfileVideosState extends State<ProfileVideos> {
  ...
  onScrollLeft() {
    _pageController.animateTo(_pageController.offset - _pageWidth, curve: Curves.linear, duration: Duration(milliseconds: 500));
    setState(() {
      _currentPageIndex--;
    });
  }
      ...
      children: [
        Container(
            ...
            child: Row(
              ...
              children: [
                Text(AppLocalizations.of(context).translateWithArgs("app_profile_lblVideos", [widget.videosNum.toString()]), style: TextStyle(color: Theme.of(context).primaryColor, fontSize: 18, fontWeight: FontWeight.w500)),
        ...
        Container(
            ...
            child: widget.videosNum == 0
                ? Padding(
                    ...
                    child: Center(
                        child: Text(widget.isMe ? AppLocalizations.of(context).translate("app_profile_youHaveNoVideos") : AppLocalizations.of(context).translateWithArgs("app_profile_noVideos", [widget.userInfo.username]),
