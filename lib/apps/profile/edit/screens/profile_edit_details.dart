...
class ProfileEditDetails extends StatefulWidget {
  ProfileEditDetails({Key key, this.profileInfo, this.mySize, this.onClose});

  final ProfileInfo profileInfo;
  final Size mySize;
  final Function onClose;

  ProfileEditDetailsState createState() => ProfileEditDetailsState(key: key);
}

class ProfileEditDetailsState extends State<ProfileEditDetails> {
  ProfileEditDetailsState({Key key});
